...
function App() {
  ...
  const handleShorten = (e: React.MouseEvent<HTMLButtonElement>): void => {
    ...
    if (url.trim() && validateUrl(url)) {
      ...
      setLoading(true)
      axios
        .post(`${process.env.REACT_APP_API_BASE_URL}/encode`, { url })
  ...
  return (
    <div>
      <div className="content-wrapper">
        <h1 className="page-title">SWFTBOX URL Shortner</h1>
        ...
        {shortenUrl && (
          <>
            <h3 className="response-title">Shorten URL:</h3>
            <div className="response-link-wrapper">
              <a
                target="_blank"
                rel="noreferrer"
